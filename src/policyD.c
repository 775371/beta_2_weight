...
void
policyDss(int n, double *y[], double *value, double *con_mean, double *tr_mean, double *risk, double *wt, double *treatment, 
...
void
policyD(int n, double *y[], double *x, int nclass,
...
double policyDpred(double *y, double wt, double treatment, double *yhat, double propensity) // pass in ct.which
{
	double ystar;
	double temp;
